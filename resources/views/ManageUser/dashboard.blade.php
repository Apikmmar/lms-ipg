...
<head>
    ...
    <style>
        .content-apps {
            background-color: rgb(238,238,238,255);
            padding: 30px;
            margin-left: 210px;
...
<body style="background-color: #eeeeee;">
    ...
    <div class="sidebar">
        <div class="row"
            style="background-image:url('asset/photo/studentbackground.jpg'); width:211px; height: 450px; ">
            <img src="{{ asset('asset/photo/studentprofile.jpeg') }}" alt="profile.png"
    ...
    <div class="container content-apps">
        @include('ManageUser.partials.homepage')
    </div>
